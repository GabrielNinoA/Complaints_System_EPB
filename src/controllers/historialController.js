...
class HistorialController {
    constructor() {
        ...
        this.getConsumerStats = this.getConsumerStats.bind(this);
    }
    ...
    async getHistorialStats(req, res) {
        try {
            ...
            const stats = await kafkaConsumer.getDatabaseStats();
    ...
    async getConsumerStats(req, res) {
        try {
            ...
            const totalRecords = await kafkaConsumer.getTotalRecords();
            ...
            console.error('❌ Error obteniendo estadísticas del consumer:', error.message);
            return this.sendErrorResponse(res, 500, 'Error obteniendo estadísticas', error);
        }
    }
